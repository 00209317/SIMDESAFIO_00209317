 ...
 * @author danie
 */
public class TablaConectividades extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tabla de Conectividades");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/desafio/image/conectivity.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaConectividades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaConectividades().setVisible(true);
            }
        });
    }
